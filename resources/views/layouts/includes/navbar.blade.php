...
<div class="app-navbar flex-shrink-0">
    ...
    <div class="app-navbar-item ms-3 ms-lg-5" id="kt_header_user_menu_toggle">
        ...
        <div class="cursor-pointer symbol symbol-35px symbol-md-40px"
            ...
            <img class="symbol symbol-circle symbol-35px symbol-md-40px" src="{{ env('APP_URL') }}assets/media/avatars/300-13.jpg"
                 alt="user" />
        </div>
        ...
        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
            ...
            <div class="menu-item px-3">
                <div class="menu-content d-flex align-items-center px-3">
                    ...
                    <div class="symbol symbol-50px me-5">
                        <img alt="Logo" src="{{ env('APP_URL') }}assets/media/avatars/300-13.jpg" />
                    </div>
                    <!--end::Avatar-->
                    <!--begin::Username-->
            ...
            <span class="menu-title position-relative">
                ...
                <span class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">
                    English <img class="w-15px h-15px rounded-1 ms-2" src="{{ env('APP_URL') }}assets/media/flags/united-states.svg"
                                 alt="" />
                </span>
            </span>
                </a>
                ...
                <div class="menu-sub menu-sub-dropdown w-175px py-4">
                    ...
                    <span class="symbol symbol-20px me-4">
                        <img class="rounded-1" src="{{ env('APP_URL') }}assets/media/flags/united-states.svg" alt="" />
                    </span>
                            English
                        </a>
                    </div>
                    ...
                    <span class="symbol symbol-20px me-4">
                        <img class="rounded-1" src="{{ env('APP_URL') }}assets/media/flags/spain.svg" alt="" />
                    </span>
                            Spanish
                        </a>
                    </div>
                    ...
                    <div class="menu-item px-3">
                        <a href="?page=account/settings" class="menu-link d-flex px-5">
                    <span class="symbol symbol-20px me-4">
                        <img class="rounded-1" src="{{ env('APP_URL') }}assets/media/flags/germany.svg" alt="" />
                    </span>
                            German
                        </a>
                    </div>
                    ...
                    <div class="menu-item px-3">
                        <a href="?page=account/settings" class="menu-link d-flex px-5">
                    <span class="symbol symbol-20px me-4">
                        <img class="rounded-1" src="{{ env('APP_URL') }}assets/media/flags/japan.svg" alt="" />
                    </span>
                            Japanese
                        </a>
                    </div>
                    ...
                    <div class="menu-item px-3">
                        <a href="?page=account/settings" class="menu-link d-flex px-5">
                    <span class="symbol symbol-20px me-4">
                        <img class="rounded-1" src="{{ env('APP_URL') }}assets/media/flags/france.svg" alt="" />
                    </span>
                            French
                        </a>
                    </div>
