            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                ...
                <form id="kt_modal_main_form" class="form" action="#">
                    ...
                    <div class="mb-13 text-center">
                        <!--begin::Title-->
                        <h1 class="mb-3">Form Category</h1>
                        <!--end::Title-->
                    </div>
                    <!--end::Heading-->
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <label class="d-flex align-items-center fs-6 fw-semibold mb-2" for="name">
                            ...
                            <span class="ms-1" data-bs-toggle="tooltip" title="Nama Category required">
	                            <i class="ki-outline ki-information-5 text-gray-500 fs-6"></i>
                            </span>
                        </label>
                        <!--end::Label-->
                        <input type="text" class="form-control form-control-solid" placeholder="Enter Nama Category" name="name" id="name"/>
                    </div>
                    <!--end::Input group-->
