                ...
                <form id="kt_modal_main_form" class="form" action="#">
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <label class="d-flex align-items-center fs-6 fw-semibold mb-2" for="nama">
                            <span class="required">Nama Lokasi</span>
                            <span class="ms-1" data-bs-toggle="tooltip" title="Nama Lokasi required">
	                            <i class="ki-outline ki-information-5 text-gray-500 fs-6"></i>
                            </span>
                        </label>
                        <!--end::Label-->
                        <input type="text" class="form-control form-control-solid" placeholder="Enter Nama Lokasi" name="nama" id="nama"/>
                    </div>
                    <!--end::Input group-->
